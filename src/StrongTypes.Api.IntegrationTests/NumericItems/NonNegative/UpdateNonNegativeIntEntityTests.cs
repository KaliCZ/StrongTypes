...
public sealed class UpdateNonNegativeIntEntityTests(TestWebApplicationFactory factory)
    : NonNegativeIntEntityTestBase(factory)
{
    ...
    public async Task NonNullable_UpdatesValueAndNullableValueInBothDatabases()
    {
        ...
        await AssertEntity(SqlSet, created.Id, NonNegative<int>.Create(100), NonNegative<int>.Create(200));
        await AssertEntity(PgSet, created.Id, NonNegative<int>.Create(100), NonNegative<int>.Create(200));
    }
    ...
    public async Task Nullable_SetsNullableValueFromNullToValueInBothDatabases()
    {
        ...
        await AssertEntity(SqlSet, created.Id, NonNegative<int>.Create(5), NonNegative<int>.Create(42));
        await AssertEntity(PgSet, created.Id, NonNegative<int>.Create(5), NonNegative<int>.Create(42));
    }
